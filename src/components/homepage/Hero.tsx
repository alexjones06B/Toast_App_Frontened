      ...
      <div className="hero-content text-center px-8 py-16">
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/participants" className="btn btn-neutral btn-lg shadow-toast hover:shadow-toast-hover hover:-translate-y-1 transition-all">
              View Participants
            </Link>
            <Link to="/leaderboard" className="btn btn-primary btn-lg shadow-toast hover:shadow-toast-hover hover:-translate-y-1 transition-all">
              See Leaderboard
            </Link>
          </div>
        </div>
