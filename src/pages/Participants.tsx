  ...
  return (
    <div className="participants-page">
      <div className="participants-header">
        ...
        <button className="btn btn-primary add-participant-btn" onClick={handleAddParticipant}>
          ➕ Add Participant
        </button>
      </div>
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card">
            <div className="stat-value" style={{ fontSize: '1.5rem' }}>
              {mockParticipants.find(p => p.timesToasted === Math.max(...mockParticipants.map(p => p.timesToasted)))?.name}
            </div>
            ...
            <div key={participant.id} className="participant-card">
              <div className="participant-info">
                ...
                <div className="participant-stats">
                  ...
                  <div className="participant-stat">
                    <span className="stat-value-small">{new Date(participant.joinDate).toLocaleDateString()}</span>
